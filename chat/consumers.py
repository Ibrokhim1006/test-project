...
class ChatConsumer(WebsocketConsumer):
    ...
    def receive(self, text_data=None, bytes_data=None):
        ...
        if attachment:
            ...
            _message = ChatMessage.objects.create(sender=sender, attachment=file_data, text=message, conversation=conversation)
        else:
            _message = ChatMessage.objects.create(sender=sender, text=message, conversation=conversation)
